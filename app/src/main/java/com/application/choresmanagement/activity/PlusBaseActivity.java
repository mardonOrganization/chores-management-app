 ...
 */
public abstract class PlusBaseActivity extends ActionBarActivity implements ConnectionCallbacks, OnConnectionFailedListener {
	...
	/**
	 * Called when the {@link PlusClient} is blocking the UI. If you have a progress bar widget, this tells you when to show or hide it.
	 */
	protected abstract void onPlusClientBlockingUI(boolean show);

	/**
	 * Called when there is a change in connection state. If you have "Sign in"/ "Connect", "Sign out"/ "Disconnect", or "Revoke access" buttons, this lets you know when their states need to be updated.
	 */
...
/*	*//**
	...
	/**
	 * Connect the {@link PlusClient} only if a connection isn't already in progress. This will call back to {@link #onConnected(android.os.Bundle)} or {@link #onConnectionFailed(com.google.android.gms.common.ConnectionResult)}.
	 */
	...
	/**
	 * Disconnect the {@link PlusClient} only if it is connected (otherwise, it can throw an error.) This will call back to {@link #onDisconnected()}.
	 */
...
//			});
	...
	/**
	 * A helper method to flip the mResolveOnFail flag and start the resolution of the ConnectionResult from the failed connect() call.
	 */
